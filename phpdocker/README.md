...
------|---------|-----------
Webserver|[localhost:3100](http://localhost:3100)
Mailhog web interface|[localhost:3101](http://localhost:3101)
MySQL|**host:** `localhost`; **port:** `3102`
MariaDB|**host:** `localhost`; **port:** `3103`
